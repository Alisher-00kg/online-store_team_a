...
const StyledButton = styled(({ variantType, radio, value, ...rest }) => (
  <Button {...rest} />
))(({ variantType, radio, value }) => {
  let styles = {};
  const isActive = radio === value;
  ...
  switch (variantType) {
    ...
    case "category":
      styles = {
        ...
        backgroundColor: isActive ? "rgba(48, 114, 63, 0.8)" : "transparent",
        fontSize: "12px",
        "&:active, &:hover": {
